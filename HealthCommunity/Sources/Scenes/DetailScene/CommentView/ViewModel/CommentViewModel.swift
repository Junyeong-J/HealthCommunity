        ...
        networkManager.request(api: .post(.specificPost(id: input.postDetail.postID)), model: Post.self)
            .flatMap { result -> Single<Post> in
                ...
                case .failure(let error):
                    print("Error: \(error)")
                    return Single.just(Post(postID: "", productID: "", title: "", content: "", content2: "", content3: "", content4: "", createdAt: "", creator: Creator(userID: "", nick: "", profileImage: ""), files: [], likes: [], likes2: [], hashTags: [], comments: []))
                }
            }
